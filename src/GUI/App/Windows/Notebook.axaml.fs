...
/// <summary>
/// Information about a cell in the notebook.
/// </summary>
type NotebookCell = {
    Type: CellType
    Content: string
...
type NotebookWindow() as this =
    ...
    /// <summary>
    /// Set up the text editor with the TextMate grammar.
    /// </summary>
    /// <param name="editor">The text editor to set up.</param>
    ...
    /// <summary>
    /// Initialise the notebook window.
    /// </summary>
